...
#define STRING_CONFIG_H_AUTHOR "(Fracktal Works, default config)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100,  100, 503.937, 140 }//{ 100, 100, 3200, 140 }
...
#define Z_PROBE_LOW_POINT          -40 // Farthest distance below the trigger-point to go before stopping
